    ...
    return (
        <div>
            ...
            <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-[#171e3d]">
                    <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-5">
                        <img src={avatar} class="rounded h-8 me-3 sm:h-10" alt="Flowbite Logo" />
                        <div>
                            <div class="self-center font-semibold whitespace-nowrap text-white">Mayank Raja</div>
                            <div class="self-center text-sm underline whitespace-nowrap text-white">Visit Store</div>
                        </div>
                    </a>
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-300 hover:bg-gray-100 hover:text-gray-900 group">
